...
<button class="py-2.5 px-4 w-full md:w-auto absolute bg-black cursor-pointer !color-white top-12 z-1 md:top-0 right-0 text-xl" on:click={() => $store.showReservation = true}>Jetzt reservieren</button>
